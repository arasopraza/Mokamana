        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto navbar-config text-sedang font-18">
                    <a class="nav-link pl-4 active" href="#">Galeri<span class="sr-only">(current)</span></a>
                    ...
                    <a class="nav-link pl-4 profile-icon" href="#" tabindex="-1" aria-disabled="true">
                        <img src="assets/icon/profile-icon.png" style="width: 24px;" alt="">
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="container justify-content-center">
        <section class="row">
            <section class="col-lg-12 mt-lg-5 mb-lg-5">
                <p class="judul text-tebal font-32">Destinasi Populer</p>
            </section>
        </section>
        ...
        <section class="row">
            <section class="col-lg-4">
                <a href="#" class="ahref-no-decor second-text-color ">
                    <div class="card">
                        <div class="border-image">
                            <img src="assets/img/bunaken.png" class="card-img-top" alt="..."></div>
                        <div class="card-body">
                            <h5 class="card-title">Taman laut bunaken</h5>
                            <div class="pulau">
                                <p class="card-text text-biasa">Sulawesi Utara</p>
                            </div>
                            <p class="text-kecil font-12 mt-4 mb-n1">Mulai dari</p>
                            <p class="text-tebal mb-0">Rp <span class="warna-harga">600.000</span><span
                                    class="text-biasa kecil">/org</span>
            ...
            <section class="col-lg-4">
                <a href="#" class="ahref-no-decor second-text-color ">
                    <div class="card border-image">
                        <img src="assets/img/danau-toba.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Danau Toba</h5>
                            <div class="pulau">
                                <p class="card-text text-biasa">Sumatera Utara</p>
                            </div>
                            <p class="text-kecil font-12 mt-4 mb-n1">Mulai dari</p>
                            <p class="text-tebal mb-0">Rp <span class="warna-harga">600.000</span><span
                                    class="text-biasa kecil">/org</span>
            ...
            <section class="col-lg-4">
                <a href="#" class="ahref-no-decor second-text-color ">
                    <div class="card border-image">
                        <img src="assets/img/danau-kelimutu.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Danau Kelimutu</h5>
                            <div class="pulau">
                                <p class="card-text text-biasa">Nusa Tenggara Timur</p>
                            </div>
                            <p class="text-kecil font-12 mt-4 mb-n1">Mulai dari</p>
                            <p class="text-tebal mb-0">Rp <span class="warna-harga">600.000</span><span
                                    class="text-biasa kecil">/org</span>
