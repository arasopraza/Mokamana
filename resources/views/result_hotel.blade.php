...
function get_CURL($url)
{
    ...
    curl_setopt_array($curl, [
        ...
        CURLOPT_HTTPHEADER => [
            ...
            "x-rapidapi-key: 9feb502d96msh247c46d3bb319c7p1c1df8jsn57b05468143f"
        ],
    ]);
...
<section class="row justify-content-center">
    <form class="form-container-search-hotel">
        <div class="inputwith_icon margin-top-160 search-hotel-box">
            ...
            <input type="text" class="form-control search-box searchinput" id="search_hotel" aria-describedby="emailHelp" placeholder="{{ $data->cari }}" autofocus>
        </div>
